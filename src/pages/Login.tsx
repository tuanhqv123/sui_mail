        ...
        <div className="bg-white border-4 border-black rounded-3xl shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] p-12">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1
                className="font-extrabold text-4xl bg-gradient-to-r from-cyan-500 via-blue-600 to-indigo-600 bg-clip-text text-transparent"
                style={{
                  fontFamily:
            ...
            <p className="text-2xl text-cyan-600 font-bold mb-4">
              Pure fluidity
            </p>
            <p className="text-xl text-gray-700 font-medium">
              Connect your wallet to dive into private messaging
            </p>
          </div>
